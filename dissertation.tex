...
\cite{chang1999methodical} later proposed a fuzzy time series model using simplified arithmetic operations instead of a complicated max-min composition. The model is defined as follows:
