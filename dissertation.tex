...
The basic fuzzy time series model performed poorly compared to the other models. It consistently performed worse than half the models tested. However, it was generally more accurate than the random walk model.
...
This project explored the use of fuzzy time series analysis to model and forecast an econometric time series. The a review was carried out on the literature studying technical analysis and the evidence surrounding the use of past price to forecast future price. It emerged that the use of technical analysis is controversial. The efficient market hypothesis claims that the price of a security already reflects all information about that security and analysing past price in order to forecast future price is futile. However, positive evidence was found for trading strategies which implemented technical analysis. Several theoretical and empirical explanations for this were outlined.
