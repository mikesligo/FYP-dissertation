...
In this definition, $Y(t)$ represents a time series, with the function returning a value at different points along time $t$. The range of values of this time series at time $t$ represents a universe of discourse at time $t$. A set of linguistic variables are defined over this universe of discourse. $f_i(t)$ are the fuzzy sets of these linguistic variables, that is the membership of the linguistic variables in each fuzzy set $f_i(t)$ which was defined over the universe of discourse. $F(t)$ is the collection of all of these fuzzy sets. This collection of fuzzy sets at any point $t$ on a time series is called a fuzzy time series.
\end{chendef}
