...
Many speed optimisations were achieved with a fuzzy toolkit that was designed knowing the constraints with which it would be used. 

Initially a generic fuzzy logic toolkit was implemented. Fuzzification, identifying matching fuzzy logical relationship groups and fuzzy intersection required a large amount of $O(n)$ operations.
