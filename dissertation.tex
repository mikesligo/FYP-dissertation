...
The model implements fuzzy time series analysis, which identifies fuzzy relationships between points on a time series and uses these to forecast observations. A fuzzy time series model identifies fluctuations in a time series as relationships between points in time, such that when similar points in the time series reappear the history of fuzzy logical relationship can be used to forecast observations.

Fuzzy logic

fuzzy logic accounts for the less stringent
