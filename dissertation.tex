...
This project sets out to create a framework for developing, modifying and testing fuzzy times series models with the goal of identifying technical trading patterns in an econometric time series. Several fuzzy time series models are designed and their forecasting performance is evaluated. The project also seeks to examine the literature on technical analysis and the justification for its use.
...
The models studied in this project utilise fuzzy logic and fuzzy set theory in their analysis. Fuzzy set theory is a branch of set theory used in fuzzy logic where values have a degree of membership in a set, instead of either being in the set or not as in crisp set theory. This adds a degree of fuzziness when using these sets, as values are 'kind-of' in a set to different degrees. Human linguistics map very well to these fuzzy sets. People use linguistic terms such as 'tall' or 'heavy' to describe objects. The boundaries for these terms are fuzzy. A man who is 180cm tall may be described as 'kind-of' tall as well as 'kind-of' average, and he may be described as more tall than average.
