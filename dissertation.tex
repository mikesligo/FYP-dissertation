...
A $n$-length moving window fuzzy time series can also be a $n$-order fuzzy time series by taking multiple moving window sequences on the time series and recording the relationship with the current observation in separate sets of fuzzy logical relationship groups.
