...
The RMSE performance indicate does not indicate how a model would perform under trading conditions. The RMSE performance indicator give the sample standard deviation of the forecasting error. It is used to measure the variance of a time series forecasting tool.
