...
Evaluation was performed on the EURUSD dataset as a result of findings by \cite{taprofitability} that technical analysis is more suited to the foreign exchange market and that a large percentage of foreign exchange analysts utilised technical analysis.

The data from $2001/01/03$ to $2009/12/31$ was chosen to train the models. The forecasting performance of the models was tested on the data from $2010/01/04$ to $2014/02/21$. 
...
\begin{table}[H]
	...
	Basic Model & 0.00893 \\
	\hline
	Higher-order Model (n=5) & \\
	\hline
	Higher-order Model (n=10) & \\
	\hline
	Moving-window Model (n=3) & \\
	\hline
	Moving-window Model (n=5) & \\
	\hline
	Change-analysis - Basic & \\
	\hline
	Change-analysis - Higher-order (n=5) & \\
	\hline
	Change-analysis - Moving-window (n=3) & \\
	\hline
	Random Walk Model & \\
	\hline
	Buy \& Hold Model & \\
