...
``You don't remember important facts and you don't remember because nobodies talking about it ... we forget and so we repeat mistakes from the past'' claimed Robert Shiller in his Nobel Prize acceptance speech, shortly after Fama. These repeated mistakes are what interest technical analysts. The goal of technical analysts is to identify any regularities in financial markets that can be used to forecast future price. 

tODO cont

In his acceptance speech for a 2013 Nobel Prize in Economic Science, Robert Shiller commented ``You don't remember important facts and you don't remember because nobodies talking about it ... we forget and so we repeat mistakes from the past''. This was shortly after the acceptance speech by Eugene Fama for the same award for his pioneering work demonstrating the efficient market hypothesis commenting 

Despite this model going against the intuitions of many analysts, that they can outsmart the market for profit, there is a large body of evidence supporting it.
