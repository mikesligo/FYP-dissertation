...
\cite{huarng2006ratio} followed a similar method except used the ratio between the relative differences of points instead of the first differences. Nb my method will probably do this but with zscores, seems to solve the current issues
