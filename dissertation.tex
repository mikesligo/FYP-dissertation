...
The models were evaluated using the root mean squared error as a performance indicator. Three financial datasets were used as experimental datasets. Several models were evaluated with different sets of parameters. Two naive models were also tested for comparison. 
